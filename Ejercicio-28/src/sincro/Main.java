...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Jugador> jugadoresEnReserva = seleccion.obtenerReservas();
        System.out.println("Jugadores en reserva");
        for (Jugador jug:jugadoresEnReserva) {
            System.out.println(jug.getApellido());
        }
        System.out.println("");
        ...
        System.out.println("Generamos un error para probar el catch");
        try{
            System.out.println("Cantidad de defensores: "+seleccion.cantJugadores("asd"));
        }catch (Exception e){
            e.printStackTrace();
        }
    }
